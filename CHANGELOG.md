...
- Grok live STT finalizes when the mic stops (existing Stream audio while recording toggle). Ordinary dictation skips LLM cleanup and screenshots; turn off Preserve exact wording to opt back into cleanup.
